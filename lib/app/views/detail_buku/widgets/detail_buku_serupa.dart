...
class DetailBukuSerupa extends StatelessWidget {
  final DetailBukuController ctrl;
  const DetailBukuSerupa({super.key, required this.ctrl});

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      if (ctrl.bukuSerupa.isEmpty) return const SizedBox.shrink();
      return Column(
        ...
        children: [
          ...
          GridView.builder(
            ...
            itemCount: ctrl.bukuSerupa.length,
            itemBuilder: (_, i) => _BukuSerupaCard(buku: ctrl.bukuSerupa[i]),
          ),
        ],
      );
    });
...
class _BukuSerupaCard extends StatelessWidget {
  final BookModel buku;
  const _BukuSerupaCard({required this.buku});
