...
class DpBukuInfoCard extends StatelessWidget {
  final DetailPeminjamanController ctrl;
  final BorrowingDetailModel d;
  const DpBukuInfoCard({super.key, required this.ctrl, required this.d});
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: ctrl.statusColor.withValues(alpha: 0.1),
                        borderRadius: BorderRadius.circular(8),
                      ),
                      child: Text(ctrl.statusLabel,
                          style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: ctrl.statusColor)),
                    ),
                  ],
                ),
