...
class DpDendaCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Ambil info transaksi dari timeline entry bayar_denda
    ...
    return AnimatedContainer(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      lunas ? 'Denda Telah Dibayar' : 'Denda Terlambat',
                      style: TextStyle(
                        fontSize: 12,
          ...
          // Detail transaksi — hanya tampil jika sudah lunas
          if (lunas && transaksi != null) ...[
            ...
            Row(
              children: [
                const Icon(Icons.receipt_long_rounded, size: 13, color: Color(0xFF2E7D32)),
