...
class KkBukuSummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final totalRating = d['total_rating'] as int? ?? 0;
    final isPopuler = (d['book_total_dipinjam'] as int? ?? 0) > 0 &&
        rating >= 4.0 && totalRating >= 3;
    final kategori = d['category_name'] as String?;
    final genre = d['genre'] as String?;
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(d['book_judul'] as String? ?? '-',
                ...
                Text(d['pengarang'] as String? ?? d['book_pengarang'] as String? ?? '-',
