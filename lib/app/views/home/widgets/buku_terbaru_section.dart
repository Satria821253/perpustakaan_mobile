...
class BukuTerbaruSection extends StatelessWidget {
  final HomeController ctrl;
  const BukuTerbaruSection({super.key, required this.ctrl});
    ...
    return Column(
      children: [
        Padding(
          ...
          child: Row(
            children: [
              const Text('Katalog Buku Terbaru',
                  style: TextStyle(
                      fontSize: 18,
        ...
        Obx(() {
          if (ctrl.isLoadingTerbaru.value) {
            return const Padding(
              padding: EdgeInsets.symmetric(vertical: 32),
              child: CircularProgressIndicator(),
            );
          }
          if (ctrl.bukuTerbaru.isEmpty) {
            return const Padding(
              padding: EdgeInsets.symmetric(vertical: 32),
          ...
          final tampil = ctrl.bukuTerbaru.take(4).toList();
          return GridView.builder(
            ...
            itemBuilder: (_, i) => _BukuTerbaruCard(buku: tampil[i]),
          );
        }),
      ],
    );
...
class _BukuTerbaruCard extends StatelessWidget {
  final BookModel buku;
  const _BukuTerbaruCard({required this.buku});
