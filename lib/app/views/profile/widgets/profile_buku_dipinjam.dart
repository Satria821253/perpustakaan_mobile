      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const Text('Buku Sedang Dipinjam',
                ...
                GestureDetector(
                  ...
                  child: const Text('Lihat Semua',
                      style: TextStyle(color: Color(0xFF1565C0), fontSize: 12, fontFamily: 'Poppins')),
                ),
              ],
            ),
            ...
            SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, i) => _BukuItem(buku: ctrl.activeBorrowings[i]),
              ),
            ),
          ],
        ),
...
class _BukuItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cover = rawCover?.replaceFirst(RegExp(r'https?://localhost:\d+'), 'http://192.168.1.19:5000')
                           .replaceFirst(RegExp(r'https?://127\.0\.0\.1:\d+'), 'http://192.168.1.19:5000');
    ...
    print('[BUKU DIPINJAM] raw: $buku');
    print('[BUKU DIPINJAM] $judul → rating=$rating totalDipinjam=$totalDipinjam isPopuler=$isPopuler');
    ...
    return GestureDetector(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: terlambat ? const Color(0xFFFFCDD2) : Colors.grey.shade200),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: terlambat ? const Color(0xFFFFEBEE) : const Color(0xFFE3F2FD),
                    borderRadius: BorderRadius.circular(4),
                  ),
                  child: Text(
                    terlambat ? '⚠ Terlambat' : '$hariTersisa hari lagi',
                    style: TextStyle(fontSize: 10, fontWeight: FontWeight.w600,
                        color: terlambat ? const Color(0xFFD32F2F) : const Color(0xFF1565C0),
                        fontFamily: 'Poppins'),
                  ),
                ),
                const SizedBox(height: 4),
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: terlambat ? const Color(0xFFD32F2F) : const Color(0xFF1565C0),
                      foregroundColor: Colors.white,
                      padding: EdgeInsets.zero,
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6)),
                      elevation: 0,
                    ),
                    child: Text(terlambat ? 'Kembalikan' : 'Perpanjang',
                        style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w600, fontFamily: 'Poppins')),
                  ),
                ),
              ],
            ),
