...
class CardJatuhTempo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bannerColor = terlambat ? const Color(0xFFD32F2F) : const Color(0xFFF57C00);
    final bgColor = terlambat ? const Color(0xFFFFEBEE) : const Color(0xFFFFF8E1);
    final borderColor = terlambat ? const Color(0xFFEF9A9A) : const Color(0xFFFFCC02);
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: bannerColor.withValues(alpha: 0.12), blurRadius: 12, offset: const Offset(0, 4))
          ],
        ),
        child: Column(
          children: [
            Container(
              ...
              child: Row(
                children: [
                  Icon(terlambat ? Icons.error_rounded : Icons.warning_amber_rounded,
                          ...
                          children: [
                            ...
                            ClipRRect(
                              ...
                              child: LinearProgressIndicator(
                                value: terlambat ? 0.0 : (buku.hariTersisa / buku.durasiPinjam).clamp(0.0, 1.0),
                            ...
                            Text(
                              ...
                              style: TextStyle(
                                  fontSize: 10, color: bannerColor,
                                  fontWeight: FontWeight.w600, fontFamily: 'Poppins'),
                            ),
                            const SizedBox(height: 8),
                            Row(children: [
                              const Icon(Icons.event_outlined, size: 13, color: Colors.black45),
                              const SizedBox(width: 4),
                              Text('Jatuh Tempo: ${buku.tanggalKembali}',
                                  style: const TextStyle(
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(width: 4),
                                    Text('Denda: Rp ${formatRupiah(buku.denda)}',
                                        style: const TextStyle(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: FilledBtn(
                          ...
                          label: terlambat ? 'Kembalikan Sekarang' : 'Kembalikan',
                          color: bannerColor,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.circular(16),
          border: Border.all(color: const Color(0xFFC8E6C9).withValues(alpha: 0.8)),
          boxShadow: [
                ...
                children: [
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () => Get.toNamed(Routes.detail, arguments: buku.bookId),
                        child: CoverWidget(cover: buku.coverImage, width: 80, height: 110),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(children: [
                              ...
                              Text('Dikembalikan: ${buku.tanggalKembali}',
                                  style: const TextStyle(
                                      fontSize: 12, color: Colors.black54, fontFamily: 'Poppins')),
                            ]),
                            const SizedBox(height: 4),
                            Row(children: [
                              const Icon(Icons.monetization_on_outlined, size: 13, color: Colors.black38),
                              const SizedBox(width: 5),
                              Text('Denda: Rp ${formatRupiah(buku.denda)}',
                                  style: TextStyle(
                                      fontSize: 12,
                                      fontWeight: adaDenda ? FontWeight.w700 : FontWeight.w400,
                                      color: adaDenda ? const Color(0xFFD32F2F) : Colors.black54,
                                      fontFamily: 'Poppins')),
                            ]),
                          ],
                        ),
