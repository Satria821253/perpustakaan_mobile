...
class _ReviewItem extends StatelessWidget {
          ...
          children: [
            ...
            ListTile(
              ...
              title: const Text('Laporkan Ulasan',
                  style: TextStyle(fontFamily: 'Poppins', fontSize: 14, color: Colors.redAccent)),
              onTap: () { Get.back(); ctrl.showReportDialog(reviewId); },
            ),
            const SizedBox(height: 8),
          ],
        ),
  ...
  Widget build(BuildContext context) {
    ...
    print('[REVIEW ITEM] id=$reviewId nama=$nama user_id=${data['user_id']} myUserId=${ctrl.myUserId} isOwner=$isOwner');
            ...
            children: [
              ...
              if (isOwner) ...[
                ...
                _SheetTile(
                  ...
                  labelColor: Colors.redAccent,
                  onTap: () { Get.back(); ctrl.showReportReplyDialog(reviewId, replyId); },
                ),
            ],
          ),
        ),
