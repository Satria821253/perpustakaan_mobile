      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            ...
            // Total Dibaca
            Row(mainAxisSize: MainAxisSize.min, children: [
              const Icon(Icons.menu_book_rounded, color: Color(0xFF1565C0), size: 14),
              const SizedBox(width: 3),
              Text('${_formatNum(buku.totalDibaca)} Dibaca',
                  style: const TextStyle(fontSize: 12, color: Colors.black54, fontFamily: 'Poppins')),
            ]),
            _divider(),
            // Status
            ...
            // Halaman · Format
            Row(mainAxisSize: MainAxisSize.min, children: [
              const Icon(Icons.description_outlined, size: 13, color: Colors.black38),
              const SizedBox(width: 3),
