...
class FavoriteItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final genreNames = genreStr.split(',').map((g) => g.trim()).where((g) => g.isNotEmpty).toList();
    ...
    return GestureDetector(
      onTap: () => Get.toNamed(Routes.detail, arguments: item['book_id'] as int),
      child: Container(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text('${double.tryParse('${item['rating']}')?.toStringAsFixed(1) ?? '0.0'}',
                      ...
                      GestureDetector(
                        onTap: onRemove,
                        child: const Icon(Icons.favorite, color: Color(0xFFE84B1A), size: 20),
                      ),
                    ],
                  ),
                ],
