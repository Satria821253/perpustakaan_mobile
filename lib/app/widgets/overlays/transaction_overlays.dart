...
class PeminjamanOverlay {
  ...
  static void showApproved({String? message, VoidCallback? onComplete}) {
  ...
  /// Peminjaman ditolak
  static void showDenied({String? message, VoidCallback? onComplete}) {
...
class PengembalianOverlay {
  /// Pengembalian berhasil dengan koin
  static void showSuccess({String? message, VoidCallback? onComplete}) {
...
class PembayaranOverlay {
  ...
  /// Pembayaran gagal
  static void showError({String? message, VoidCallback? onComplete}) {
  ...
  static void showPending({String? message, VoidCallback? onComplete}) {
    AnimationOverlay.show(
      type: AnimationType.loading,
      title: 'Menunggu Pembayaran',
      message:
          message ??
          'Silakan selesaikan pembayaran di aplikasi payment gateway.',
      onComplete: onComplete,
...
class ReservasiOverlay {
  ...
  static void showSuccess({String? message, VoidCallback? onComplete}) {
    AnimationOverlay.showSuccess(
      ...
      message:
          message ?? 'Buku berhasil direservasi. Silakan ambil sesuai jadwal.',
      onComplete: onComplete,
    );
  }

  /// Reservasi dibatalkan
  static void showCancelled({String? message, VoidCallback? onComplete}) {
    AnimationOverlay.showDenied(
  ...
  /// Perpanjangan pending - menunggu konfirmasi petugas
  static void showPerpanjanganPending({
    String? message,
